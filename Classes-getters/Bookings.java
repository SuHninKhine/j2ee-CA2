...
public class Bookings {
    ...
    private String customerName;// Alias for username
    ...
    // Updated: Getter and Setter for username (alias for customerName)
    public String getUsername() {
        return customerName;
    }

    public void setUsername(String username) {
        this.customerName = username; // Alias for customerName
    }
